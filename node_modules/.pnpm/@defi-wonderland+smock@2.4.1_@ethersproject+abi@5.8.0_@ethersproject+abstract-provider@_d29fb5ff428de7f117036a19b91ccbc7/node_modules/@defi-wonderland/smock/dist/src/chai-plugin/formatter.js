...
exports.formatters = {
    c: (watchableContract) => {
        return (0, utils_1.humanizeTimes)(watchableContract.getCallCount());
    },
    n: (watchableContract) => {
    ...
    D: (watchableContract, args) => {
        ...
        for (var i = 0, l = watchableContract.getCallCount(); i < l; ++i) {
            ...
            for (var j = 0; j < calledArgs.length || j < expectedArgs.length; ++j) {
                ...
                if (parsedCalledArgs) {
                    if ((0, utils_1.isStruct)(parsedCalledArgs)) {
                        parsedCalledArgs = (0, utils_1.convertStructToPojo)(parsedCalledArgs);
                    }
                ...
                var diff = (0, diff_1.diffJson)(calledArgMessage, expectedArgMessage);
