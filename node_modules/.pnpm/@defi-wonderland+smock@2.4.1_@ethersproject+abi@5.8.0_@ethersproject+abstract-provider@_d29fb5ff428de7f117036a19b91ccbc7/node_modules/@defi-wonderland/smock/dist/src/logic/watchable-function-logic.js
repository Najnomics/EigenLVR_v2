...
class WatchableFunctionLogic {
    ...
    atCall(index) {
        if (!this.getCall(index))
            throw new Error(`expected ${this.name} to have been called ${(0, utils_1.humanizeTimes)(index + 1)}, but it was called ${(0, utils_1.humanizeTimes)(this.getCallCount())}`);
        return new WatchableFunctionLogic(this.name, (0, rxjs_1.of)(this.getCall(index)));
    }
    getCall(index) {
    ...
    delegatedFrom(delegatorAddress) {
        return !!this.callHistory.find((call) => { var _a; return ((_a = call.delegatedFrom) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === delegatorAddress.toLowerCase(); });
    }
    ...
    isDeepEqual(obj1, obj2) {
        return (0, lodash_isequalwith_1.default)(obj1, obj2, this.isEqualCustomizer.bind(this));
    }
    isEqualCustomizer(obj1, obj2) {
        ...
        const objectAndStruct = (0, utils_1.getObjectAndStruct)(obj1, obj2);
        if (objectAndStruct) {
            return (0, lodash_isequal_1.default)(objectAndStruct[0], (0, utils_1.convertStructToPojo)(objectAndStruct[1]));
        }
        return undefined;
    }
}
