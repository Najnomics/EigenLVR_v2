...
export interface MockSpokePoolV2Interface extends utils.Interface {
    functions: {
        ...
        "fillRelayV3Internal(((bytes32,bytes32,bytes32,bytes32,bytes32,uint256,uint256,uint256,uint256,uint32,uint32,bytes),bytes32,uint256,bytes32,bytes,uint256),bytes32,bool)": FunctionFragment;
        ...
        "verifyUpdateV3DepositMessage(address,uint256,uint256,uint256,address,bytes,bytes)": FunctionFragment;
        "verifyUpdateV3DepositMessageBytes32(bytes32,uint256,uint256,uint256,bytes32,bytes,bytes)": FunctionFragment;
        "withdrawalRecipient()": FunctionFragment;
        "wrappedNativeToken()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "EMPTY_MSG_BYTES" | "EMPTY_RELAYER" | "EMPTY_REPAYMENT_CHAIN_ID" | "INFINITE_FILL_DEADLINE" | "MAX_EXCLUSIVITY_PERIOD_SECONDS" | "MAX_TRANSFER_SIZE" | "OFT_DST_EID" | "OFT_FEE_CAP" | "SLOW_FILL_MAX_TOKENS_TO_SEND" | "UPDATE_BYTES32_DEPOSIT_DETAILS_HASH" | "UPDATE_DEPOSIT_DETAILS_HASH" | "__SpokePool_init" | "callback" | "chainId" | "claimRelayerRefund" | "crossDomainAdmin" | "deposit" | "depositDeprecated_5947912356" | "depositFor" | "depositNow" | "depositQuoteTimeBuffer" | "depositV3" | "depositV3Now" | "distributeRelayerRefunds" | "emergencyDeleteRootBundle" | "emitEvent" | "executeRelayerRefundLeaf" | "executeSlowRelayLeaf" | "fill" | "fillDeadlineBuffer" | "fillRelay" | "fillRelayV3Internal" | "fillRelayWithUpdatedDeposit" | "fillStatuses" | "fillV3Relay" | "getCurrentTime" | "getRelayerRefund" | "getUnsafeDepositId" | "getV3RelayHash" | "initialize" | "multicall" | "numberOfDeposits" | "oftMessengers" | "owner" | "pauseDeposits" | "pauseFills" | "pausedDeposits" | "pausedFills" | "proxiableUUID" | "reinitialize" | "relayRootBundle" | "relayerRefund" | "renounceOwnership" | "requestSlowFill" | "rootBundles" | "setChainId" | "setCrossDomainAdmin" | "setCurrentTime" | "setFillStatus" | "setOftMessenger" | "setWithdrawalRecipient" | "speedUpDeposit" | "speedUpV3Deposit" | "transferOwnership" | "tryMulticall" | "unsafeDeposit" | "upgradeTo" | "upgradeToAndCall" | "verifyUpdateV3DepositMessage" | "verifyUpdateV3DepositMessageBytes32" | "withdrawalRecipient" | "wrappedNativeToken"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "fillRelayV3Internal", values: [
        V3SpokePoolInterface.V3RelayExecutionParamsStruct,
        BytesLike,
        boolean
    ]): string;
    ...
    encodeFunctionData(functionFragment: "verifyUpdateV3DepositMessageBytes32", values: [
        BytesLike,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: "verifyUpdateV3DepositMessageBytes32", data: BytesLike): Result;
...
export type BridgedToHubPoolEvent = TypedEvent<[
    BigNumber,
    string
], BridgedToHubPoolEventObject>;
export type BridgedToHubPoolEventFilter = TypedEventFilter<BridgedToHubPoolEvent>;
...
export type NewEventEvent = TypedEvent<[boolean], NewEventEventObject>;
...
export type PreLeafExecuteHookEvent = TypedEvent<[
    string
], PreLeafExecuteHookEventObject>;
export type PreLeafExecuteHookEventFilter = TypedEventFilter<PreLeafExecuteHookEvent>;
...
export interface MockSpokePoolV2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockSpokePoolV2Interface;
    ...
    functions: {
        ...
        fillRelayV3Internal(relayExecution: V3SpokePoolInterface.V3RelayExecutionParamsStruct, relayer: BytesLike, isSlowFill: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        reinitialize(_hubPool: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        verifyUpdateV3DepositMessageBytes32(depositor: BytesLike, depositId: BigNumberish, originChainId: BigNumberish, updatedOutputAmount: BigNumberish, updatedRecipient: BytesLike, updatedMessage: BytesLike, depositorSignature: BytesLike, overrides?: CallOverrides): Promise<[void]>;
    ...
    callStatic: {
        ...
        fillRelayV3Internal(relayExecution: V3SpokePoolInterface.V3RelayExecutionParamsStruct, relayer: BytesLike, isSlowFill: boolean, overrides?: CallOverrides): Promise<void>;
        ...
        pausedFills(overrides?: CallOverrides): Promise<boolean>;
        proxiableUUID(overrides?: CallOverrides): Promise<string>;
        reinitialize(_hubPool: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "NewEvent(bool)"(value?: null): NewEventEventFilter;
        NewEvent(value?: null): NewEventEventFilter;
        ...
        "PreLeafExecuteHook(bytes32)"(token?: null): PreLeafExecuteHookEventFilter;
    ...
    estimateGas: {
        ...
        verifyUpdateV3DepositMessageBytes32(depositor: BytesLike, depositId: BigNumberish, originChainId: BigNumberish, updatedOutputAmount: BigNumberish, updatedRecipient: BytesLike, updatedMessage: BytesLike, depositorSignature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        verifyUpdateV3DepositMessageBytes32(depositor: BytesLike, depositId: BigNumberish, originChainId: BigNumberish, updatedOutputAmount: BigNumberish, updatedRecipient: BytesLike, updatedMessage: BytesLike, depositorSignature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
