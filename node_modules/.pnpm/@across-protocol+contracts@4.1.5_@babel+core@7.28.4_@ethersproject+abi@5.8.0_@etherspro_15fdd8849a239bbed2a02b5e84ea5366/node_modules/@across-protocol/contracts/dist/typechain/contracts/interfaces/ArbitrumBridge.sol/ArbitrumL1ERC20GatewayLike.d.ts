...
export interface ArbitrumL1ERC20GatewayLike extends BaseContract {
    ...
    functions: {
        ...
        outboundTransfer(_sourceToken: string, _to: string, _amount: BigNumberish, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        outboundTransferCustomRefund(_sourceToken: string, _refundTo: string, _to: string, _amount: BigNumberish, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    getGateway(_token: string, overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        getGateway(_token: string, overrides?: CallOverrides): Promise<string>;
        outboundTransfer(_sourceToken: string, _to: string, _amount: BigNumberish, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
        outboundTransferCustomRefund(_sourceToken: string, _refundTo: string, _to: string, _amount: BigNumberish, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
