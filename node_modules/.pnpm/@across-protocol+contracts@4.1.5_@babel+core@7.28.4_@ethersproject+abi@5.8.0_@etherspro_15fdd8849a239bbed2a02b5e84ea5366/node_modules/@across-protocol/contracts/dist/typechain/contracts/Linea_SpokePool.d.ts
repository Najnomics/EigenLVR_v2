...
export interface Linea_SpokePoolInterface extends utils.Interface {
    functions: {
        ...
        "initialize(uint32,address,address,address,address)": FunctionFragment;
        "l2MessageService()": FunctionFragment;
        ...
        "setL2MessageService(address)": FunctionFragment;
        "setL2TokenBridge(address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "EMPTY_MSG_BYTES" | "EMPTY_RELAYER" | "EMPTY_REPAYMENT_CHAIN_ID" | "INFINITE_FILL_DEADLINE" | "MAX_EXCLUSIVITY_PERIOD_SECONDS" | "MAX_TRANSFER_SIZE" | "OFT_DST_EID" | "OFT_FEE_CAP" | "UPDATE_BYTES32_DEPOSIT_DETAILS_HASH" | "__SpokePool_init" | "cctpTokenMessenger" | "cctpV2" | "chainId" | "claimRelayerRefund" | "crossDomainAdmin" | "deposit" | "depositDeprecated_5947912356" | "depositFor" | "depositNow" | "depositQuoteTimeBuffer" | "depositV3" | "depositV3Now" | "emergencyDeleteRootBundle" | "executeRelayerRefundLeaf" | "executeSlowRelayLeaf" | "fill" | "fillDeadlineBuffer" | "fillRelay" | "fillRelayWithUpdatedDeposit" | "fillStatuses" | "fillV3Relay" | "getCurrentTime" | "getRelayerRefund" | "getUnsafeDepositId" | "getV3RelayHash" | "initialize" | "l2MessageService" | "l2TokenBridge" | "minimumFeeInWei" | "multicall" | "numberOfDeposits" | "oftMessengers" | "pauseDeposits" | "pauseFills" | "pausedDeposits" | "pausedFills" | "proxiableUUID" | "recipientCircleDomainId" | "relayRootBundle" | "relayerRefund" | "requestSlowFill" | "rootBundles" | "setCrossDomainAdmin" | "setL2MessageService" | "setL2TokenBridge" | "setOftMessenger" | "setWithdrawalRecipient" | "speedUpDeposit" | "speedUpV3Deposit" | "tryMulticall" | "unsafeDeposit" | "upgradeTo" | "upgradeToAndCall" | "usdcToken" | "withdrawalRecipient" | "wrappedNativeToken"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "l2MessageService", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setL2MessageService", values: [string]): string;
    encodeFunctionData(functionFragment: "setL2TokenBridge", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "l2MessageService", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setL2MessageService", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setL2TokenBridge", data: BytesLike): Result;
    ...
    events: {
        ...
        "SetL2MessageService(address,address)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "SetL2MessageService"): EventFragment;
...
export interface SetL2MessageServiceEventObject {
    newMessageService: string;
    oldMessageService: string;
}
export type SetL2MessageServiceEvent = TypedEvent<[
    string,
    string
], SetL2MessageServiceEventObject>;
export type SetL2MessageServiceEventFilter = TypedEventFilter<SetL2MessageServiceEvent>;
export interface SetL2TokenBridgeEventObject {
    newTokenBridge: string;
    oldTokenBridge: string;
}
...
export interface Linea_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Linea_SpokePoolInterface;
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _l2MessageService: string, _l2TokenBridge: string, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        l2MessageService(overrides?: CallOverrides): Promise<[string]>;
        ...
        setL2MessageService(_l2MessageService: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setL2TokenBridge(_l2TokenBridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getUnsafeDepositId(msgSender: string, depositor: BytesLike, depositNonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getV3RelayHash(relayData: V3SpokePoolInterface.V3RelayDataStruct, overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _l2MessageService: string, _l2TokenBridge: string, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: CallOverrides): Promise<void>;
        l2MessageService(overrides?: CallOverrides): Promise<string>;
        l2TokenBridge(overrides?: CallOverrides): Promise<string>;
        minimumFeeInWei(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setL2MessageService(_l2MessageService: string, overrides?: CallOverrides): Promise<void>;
        setL2TokenBridge(_l2TokenBridge: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "SetL2MessageService(address,address)"(newMessageService?: string | null, oldMessageService?: null): SetL2MessageServiceEventFilter;
        SetL2MessageService(newMessageService?: string | null, oldMessageService?: null): SetL2MessageServiceEventFilter;
        "SetL2TokenBridge(address,address)"(newTokenBridge?: string | null, oldTokenBridge?: null): SetL2TokenBridgeEventFilter;
        SetL2TokenBridge(newTokenBridge?: string | null, oldTokenBridge?: null): SetL2TokenBridgeEventFilter;
    ...
    estimateGas: {
        ...
        l2MessageService(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        l2MessageService(overrides?: CallOverrides): Promise<PopulatedTransaction>;
