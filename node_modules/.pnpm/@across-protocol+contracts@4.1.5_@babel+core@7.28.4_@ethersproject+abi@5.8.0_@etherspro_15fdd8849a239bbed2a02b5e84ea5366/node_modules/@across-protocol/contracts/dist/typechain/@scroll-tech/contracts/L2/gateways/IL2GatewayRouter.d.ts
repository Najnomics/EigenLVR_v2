...
export type FinalizeDepositERC20EventFilter = TypedEventFilter<FinalizeDepositERC20Event>;
...
export type FinalizeDepositETHEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    string
], FinalizeDepositETHEventObject>;
export type FinalizeDepositETHEventFilter = TypedEventFilter<FinalizeDepositETHEvent>;
