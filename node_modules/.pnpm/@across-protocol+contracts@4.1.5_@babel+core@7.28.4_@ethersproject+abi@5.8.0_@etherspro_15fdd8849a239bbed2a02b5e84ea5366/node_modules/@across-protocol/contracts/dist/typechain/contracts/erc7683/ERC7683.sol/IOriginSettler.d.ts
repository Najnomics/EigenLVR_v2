...
export interface IOriginSettlerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "open" | "openFor" | "resolve" | "resolveFor"): FunctionFragment;
    ...
    events: {
        "Open(bytes32,tuple)": EventFragment;
    };
...
export interface IOriginSettler extends BaseContract {
    ...
    functions: {
        open(order: OnchainCrossChainOrderStruct, overrides?: Overrides & {
            from?: string;
    ...
    filters: {
        "Open(bytes32,tuple)"(orderId?: BytesLike | null, resolvedOrder?: null): OpenEventFilter;
