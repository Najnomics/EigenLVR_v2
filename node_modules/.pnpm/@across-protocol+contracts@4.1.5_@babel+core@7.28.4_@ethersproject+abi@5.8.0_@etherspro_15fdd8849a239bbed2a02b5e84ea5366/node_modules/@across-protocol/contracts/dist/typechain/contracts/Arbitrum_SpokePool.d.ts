...
export interface Arbitrum_SpokePoolInterface extends utils.Interface {
    functions: {
...
export interface Arbitrum_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Arbitrum_SpokePoolInterface;
