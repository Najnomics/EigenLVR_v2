...
export interface AlephZero_SpokePoolInterface extends utils.Interface {
    functions: {
...
export type WhitelistedTokensEvent = TypedEvent<[
    string,
    string
], WhitelistedTokensEventObject>;
export type WhitelistedTokensEventFilter = TypedEventFilter<WhitelistedTokensEvent>;
export interface AlephZero_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AlephZero_SpokePoolInterface;
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _l2GatewayRouter: string, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setL2GatewayRouter(newL2GatewayRouter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        whitelistToken(l2Token: string, l1Token: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getUnsafeDepositId(msgSender: string, depositor: BytesLike, depositNonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getV3RelayHash(relayData: V3SpokePoolInterface.V3RelayDataStruct, overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _l2GatewayRouter: string, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: CallOverrides): Promise<void>;
        l2GatewayRouter(overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        ...
        "WhitelistedTokens(address,address)"(l2Token?: string | null, l1Token?: string | null): WhitelistedTokensEventFilter;
