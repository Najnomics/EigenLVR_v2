...
export interface Scroll_SpokePoolInterface extends utils.Interface {
    functions: {
        ...
        "initialize(address,address,uint32,address,address)": FunctionFragment;
        "l2GatewayRouter()": FunctionFragment;
        "l2ScrollMessenger()": FunctionFragment;
        ...
        "setL2ScrollMessenger(address)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "l2ScrollMessenger", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setL2ScrollMessenger", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "l2ScrollMessenger", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setL2ScrollMessenger", data: BytesLike): Result;
    ...
    events: {
        ...
        "SetL2GatewayRouter(address,address)": EventFragment;
        "SetL2ScrollMessenger(address,address)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "SetL2ScrollMessenger"): EventFragment;
...
export interface SetL2GatewayRouterEventObject {
    newGatewayRouter: string;
    oldGatewayRouter: string;
}
export type SetL2GatewayRouterEvent = TypedEvent<[
    string,
    string
], SetL2GatewayRouterEventObject>;
export type SetL2GatewayRouterEventFilter = TypedEventFilter<SetL2GatewayRouterEvent>;
export interface SetL2ScrollMessengerEventObject {
    newScrollMessenger: string;
    oldScrollMessenger: string;
}
export type SetL2ScrollMessengerEvent = TypedEvent<[
    string,
    string
], SetL2ScrollMessengerEventObject>;
export type SetL2ScrollMessengerEventFilter = TypedEventFilter<SetL2ScrollMessengerEvent>;
...
export interface Scroll_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Scroll_SpokePoolInterface;
    ...
    functions: {
        ...
        initialize(_l2GatewayRouter: string, _l2ScrollMessenger: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        l2GatewayRouter(overrides?: CallOverrides): Promise<[string]>;
        l2ScrollMessenger(overrides?: CallOverrides): Promise<[string]>;
        ...
        setL2GatewayRouter(_l2GatewayRouter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setL2ScrollMessenger(_l2ScrollMessenger: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getUnsafeDepositId(msgSender: string, depositor: BytesLike, depositNonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getV3RelayHash(relayData: V3SpokePoolInterface.V3RelayDataStruct, overrides?: CallOverrides): Promise<string>;
        initialize(_l2GatewayRouter: string, _l2ScrollMessenger: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: CallOverrides): Promise<void>;
        l2GatewayRouter(overrides?: CallOverrides): Promise<string>;
        l2ScrollMessenger(overrides?: CallOverrides): Promise<string>;
        ...
        setL2GatewayRouter(_l2GatewayRouter: string, overrides?: CallOverrides): Promise<void>;
        setL2ScrollMessenger(_l2ScrollMessenger: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "SetL2GatewayRouter(address,address)"(newGatewayRouter?: string | null, oldGatewayRouter?: null): SetL2GatewayRouterEventFilter;
        SetL2GatewayRouter(newGatewayRouter?: string | null, oldGatewayRouter?: null): SetL2GatewayRouterEventFilter;
        "SetL2ScrollMessenger(address,address)"(newScrollMessenger?: string | null, oldScrollMessenger?: null): SetL2ScrollMessengerEventFilter;
        SetL2ScrollMessenger(newScrollMessenger?: string | null, oldScrollMessenger?: null): SetL2ScrollMessengerEventFilter;
    ...
    estimateGas: {
        ...
        l2ScrollMessenger(overrides?: CallOverrides): Promise<BigNumber>;
        multicall(data: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        l2ScrollMessenger(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        multicall(data: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
