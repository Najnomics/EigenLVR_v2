...
export interface Arbitrum_SendTokensAdapterInterface extends utils.Interface {
    functions: {
        "RELAY_TOKENS_L2_GAS_LIMIT()": FunctionFragment;
        "getL1CallValue()": FunctionFragment;
        "l1ERC20GatewayRouter()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "RELAY_TOKENS_L2_GAS_LIMIT" | "getL1CallValue" | "l1ERC20GatewayRouter" | "l2GasPrice" | "l2MaxSubmissionCost" | "l2RefundL2Address" | "relayMessage" | "relayTokens"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "l1ERC20GatewayRouter", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "l1ERC20GatewayRouter", data: BytesLike): Result;
...
export interface Arbitrum_SendTokensAdapter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Arbitrum_SendTokensAdapterInterface;
    ...
    functions: {
        ...
        l1ERC20GatewayRouter(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        getL1CallValue(overrides?: CallOverrides): Promise<BigNumber>;
        l1ERC20GatewayRouter(overrides?: CallOverrides): Promise<BigNumber>;
        l2GasPrice(overrides?: CallOverrides): Promise<BigNumber>;
        l2MaxSubmissionCost(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        l1ERC20GatewayRouter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
