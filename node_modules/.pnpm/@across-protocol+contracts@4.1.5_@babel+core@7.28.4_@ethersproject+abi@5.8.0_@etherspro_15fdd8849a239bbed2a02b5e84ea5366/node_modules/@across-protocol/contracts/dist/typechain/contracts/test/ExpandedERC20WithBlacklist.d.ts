...
export interface ExpandedERC20WithBlacklistInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "setBlacklistStatus", values: [string, boolean]): string;
    ...
    decodeFunctionResult(functionFragment: "setBlacklistStatus", data: BytesLike): Result;
...
export interface ExpandedERC20WithBlacklist extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExpandedERC20WithBlacklistInterface;
    ...
    functions: {
        ...
        setBlacklistStatus(account: string, status: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setBlacklistStatus(account: string, status: boolean, overrides?: CallOverrides): Promise<void>;
        symbol(overrides?: CallOverrides): Promise<string>;
        totalSupply(overrides?: CallOverrides): Promise<BigNumber>;
