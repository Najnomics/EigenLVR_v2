...
export interface Blast_SpokePoolInterface extends utils.Interface {
    functions: {
        "BLAST_RETRIEVER()": FunctionFragment;
        ...
        "L1_USDB()": FunctionFragment;
        "L2_BLAST_BRIDGE()": FunctionFragment;
        ...
        "YIELD_RECIPIENT()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "BLAST_RETRIEVER" | "BLAST_YIELD_CONTRACT" | "EMPTY_MSG_BYTES" | "EMPTY_RELAYER" | "EMPTY_REPAYMENT_CHAIN_ID" | "INFINITE_FILL_DEADLINE" | "L1_USDB" | "L2_BLAST_BRIDGE" | "MAX_EXCLUSIVITY_PERIOD_SECONDS" | "MAX_TRANSFER_SIZE" | "MESSENGER" | "OFT_DST_EID" | "OFT_FEE_CAP" | "UPDATE_BYTES32_DEPOSIT_DETAILS_HASH" | "USDB" | "YIELD_RECIPIENT" | "__OvmSpokePool_init" | "__SpokePool_init" | "cctpTokenMessenger" | "cctpV2" | "chainId" | "claimRelayerRefund" | "crossDomainAdmin" | "deposit" | "depositDeprecated_5947912356" | "depositFor" | "depositNow" | "depositQuoteTimeBuffer" | "depositV3" | "depositV3Now" | "emergencyDeleteRootBundle" | "executeRelayerRefundLeaf" | "executeSlowRelayLeaf" | "fill" | "fillDeadlineBuffer" | "fillRelay" | "fillRelayWithUpdatedDeposit" | "fillStatuses" | "fillV3Relay" | "getCurrentTime" | "getRelayerRefund" | "getUnsafeDepositId" | "getV3RelayHash" | "initialize" | "l1Gas" | "l2Eth" | "multicall" | "numberOfDeposits" | "oftMessengers" | "pauseDeposits" | "pauseFills" | "pausedDeposits" | "pausedFills" | "proxiableUUID" | "recipientCircleDomainId" | "relayRootBundle" | "relayerRefund" | "remoteL1Tokens" | "requestSlowFill" | "rootBundles" | "setCrossDomainAdmin" | "setL1GasLimit" | "setOftMessenger" | "setRemoteL1Token" | "setTokenBridge" | "setWithdrawalRecipient" | "speedUpDeposit" | "speedUpV3Deposit" | "tokenBridges" | "tryMulticall" | "unsafeDeposit" | "upgradeTo" | "upgradeToAndCall" | "usdcToken" | "withdrawalRecipient" | "wrappedNativeToken"): FunctionFragment;
    encodeFunctionData(functionFragment: "BLAST_RETRIEVER", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "L1_USDB", values?: undefined): string;
    encodeFunctionData(functionFragment: "L2_BLAST_BRIDGE", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "YIELD_RECIPIENT", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "BLAST_RETRIEVER", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "L1_USDB", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "L2_BLAST_BRIDGE", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "YIELD_RECIPIENT", data: BytesLike): Result;
...
export interface Blast_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Blast_SpokePoolInterface;
    ...
    functions: {
        BLAST_RETRIEVER(overrides?: CallOverrides): Promise<[string]>;
        ...
        L1_USDB(overrides?: CallOverrides): Promise<[string]>;
        L2_BLAST_BRIDGE(overrides?: CallOverrides): Promise<[string]>;
        ...
        YIELD_RECIPIENT(overrides?: CallOverrides): Promise<[string]>;
    ...
    filters: {
        ...
        "YieldClaimed(address,address,uint256)"(recipient?: string | null, token?: string | null, amount?: null): YieldClaimedEventFilter;
        YieldClaimed(recipient?: string | null, token?: string | null, amount?: null): YieldClaimedEventFilter;
    };
    estimateGas: {
        BLAST_RETRIEVER(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        L1_USDB(overrides?: CallOverrides): Promise<BigNumber>;
        L2_BLAST_BRIDGE(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        YIELD_RECIPIENT(overrides?: CallOverrides): Promise<BigNumber>;
        __OvmSpokePool_init(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, _l2Eth: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        __SpokePool_init(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
    ...
    populateTransaction: {
        BLAST_RETRIEVER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        L1_USDB(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        L2_BLAST_BRIDGE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        YIELD_RECIPIENT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        __OvmSpokePool_init(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, _l2Eth: string, overrides?: Overrides & {
            from?: string;
