...
export type BridgedMessageEvent = TypedEvent<[
    string,
    string
], BridgedMessageEventObject>;
export type BridgedMessageEventFilter = TypedEventFilter<BridgedMessageEvent>;
export interface BridgedTokensEventObject {
    token: string;
    amount: BigNumber;
}
export type BridgedTokensEvent = TypedEvent<[
    string,
    BigNumber
], BridgedTokensEventObject>;
export type BridgedTokensEventFilter = TypedEventFilter<BridgedTokensEvent>;
