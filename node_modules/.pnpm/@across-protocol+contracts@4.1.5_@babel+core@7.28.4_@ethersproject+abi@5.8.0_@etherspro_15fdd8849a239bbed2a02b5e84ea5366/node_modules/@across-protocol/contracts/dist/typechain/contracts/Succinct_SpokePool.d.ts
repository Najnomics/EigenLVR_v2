...
export type SetSuccinctTargetAmbEvent = TypedEvent<[
    string
], SetSuccinctTargetAmbEventObject>;
export type SetSuccinctTargetAmbEventFilter = TypedEventFilter<SetSuccinctTargetAmbEvent>;
...
export interface Succinct_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        initialize(_hubChainId: BigNumberish, _succinctTargetAmb: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        hubChainId(overrides?: CallOverrides): Promise<number>;
        initialize(_hubChainId: BigNumberish, _succinctTargetAmb: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: CallOverrides): Promise<void>;
