...
export interface WithdrawalHelperBaseInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "L2_TOKEN_GATEWAY" | "TOKEN_RECIPIENT" | "WRAPPED_NATIVE_TOKEN" | "__WithdrawalHelper_init" | "cctpTokenMessenger" | "cctpV2" | "crossDomainAdmin" | "multicall" | "proxiableUUID" | "recipientCircleDomainId" | "upgradeTo" | "upgradeToAndCall" | "usdcToken" | "withdrawToken"): FunctionFragment;
...
export interface WithdrawalHelperBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: WithdrawalHelperBaseInterface;
    ...
    functions: {
        ...
        withdrawToken(l1Token: string, l2Token: string, amountToReturn: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    L2_TOKEN_GATEWAY(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        usdcToken(overrides?: CallOverrides): Promise<string>;
        withdrawToken(l1Token: string, l2Token: string, amountToReturn: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
