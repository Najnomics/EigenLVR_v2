...
export interface DoctorWho_AdapterInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "L1_STANDARD_BRIDGE" | "L1_WETH" | "L2_GAS_LIMIT" | "MESSENGER" | "cctpTokenMessenger" | "cctpV2" | "recipientCircleDomainId" | "relayMessage" | "relayTokens" | "usdcToken"): FunctionFragment;
...
export interface DoctorWho_Adapter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DoctorWho_AdapterInterface;
