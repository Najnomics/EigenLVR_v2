...
export type L2TokenDisabledForLiquidityProvisionEventFilter = TypedEventFilter<L2TokenDisabledForLiquidityProvisionEvent>;
...
export type SetPoolRebalanceRouteEvent = TypedEvent<[
    BigNumber,
    string,
    string
