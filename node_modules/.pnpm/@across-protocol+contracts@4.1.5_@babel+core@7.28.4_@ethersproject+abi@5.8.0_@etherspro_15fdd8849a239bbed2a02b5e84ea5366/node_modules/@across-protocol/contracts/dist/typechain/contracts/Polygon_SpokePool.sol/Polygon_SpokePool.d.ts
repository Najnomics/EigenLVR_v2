...
export interface Polygon_SpokePoolInterface extends utils.Interface {
    functions: {
...
export type SetPolygonTokenBridgerEvent = TypedEvent<[
    string
], SetPolygonTokenBridgerEventObject>;
...
export interface Polygon_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Polygon_SpokePoolInterface;
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _polygonTokenBridger: string, _crossDomainAdmin: string, _withdrawalRecipient: string, _fxChild: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setFxChild(newFxChild: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setOftMessenger(token: string, messenger: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setPolygonTokenBridger(newPolygonTokenBridger: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getUnsafeDepositId(msgSender: string, depositor: BytesLike, depositNonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getV3RelayHash(relayData: V3SpokePoolInterface.V3RelayDataStruct, overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _polygonTokenBridger: string, _crossDomainAdmin: string, _withdrawalRecipient: string, _fxChild: string, overrides?: CallOverrides): Promise<void>;
