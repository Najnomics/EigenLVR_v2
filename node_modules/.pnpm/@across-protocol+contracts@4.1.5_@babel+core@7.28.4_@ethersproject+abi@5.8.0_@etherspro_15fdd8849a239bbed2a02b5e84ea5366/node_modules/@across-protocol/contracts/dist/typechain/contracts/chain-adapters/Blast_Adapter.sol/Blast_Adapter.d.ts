...
export interface Blast_AdapterInterface extends utils.Interface {
    functions: {
        "L1_BLAST_BRIDGE()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "L1_BLAST_BRIDGE" | "L1_DAI" | "L1_STANDARD_BRIDGE" | "L1_WETH" | "L2_GAS_LIMIT" | "MESSENGER" | "cctpTokenMessenger" | "cctpV2" | "recipientCircleDomainId" | "relayMessage" | "relayTokens" | "usdcToken"): FunctionFragment;
    encodeFunctionData(functionFragment: "L1_BLAST_BRIDGE", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "L1_BLAST_BRIDGE", data: BytesLike): Result;
...
export interface Blast_Adapter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Blast_AdapterInterface;
    ...
    functions: {
        L1_BLAST_BRIDGE(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        L1_BLAST_BRIDGE(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        L1_BLAST_BRIDGE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
