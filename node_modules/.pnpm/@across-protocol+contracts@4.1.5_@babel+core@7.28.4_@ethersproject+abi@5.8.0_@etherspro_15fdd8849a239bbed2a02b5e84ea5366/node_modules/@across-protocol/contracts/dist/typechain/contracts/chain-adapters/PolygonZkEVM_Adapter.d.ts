...
export interface PolygonZkEVM_AdapterInterface extends utils.Interface {
    functions: {
        "L1_POLYGON_ZKEVM_BRIDGE()": FunctionFragment;
        "L1_WETH()": FunctionFragment;
        "POLYGON_ZKEVM_L2_NETWORK_ID()": FunctionFragment;
        "relayMessage(address,bytes)": FunctionFragment;
        "relayTokens(address,address,uint256,address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "L1_POLYGON_ZKEVM_BRIDGE" | "L1_WETH" | "POLYGON_ZKEVM_L2_NETWORK_ID" | "relayMessage" | "relayTokens"): FunctionFragment;
    encodeFunctionData(functionFragment: "L1_POLYGON_ZKEVM_BRIDGE", values?: undefined): string;
    encodeFunctionData(functionFragment: "L1_WETH", values?: undefined): string;
    encodeFunctionData(functionFragment: "POLYGON_ZKEVM_L2_NETWORK_ID", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "L1_POLYGON_ZKEVM_BRIDGE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "L1_WETH", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "POLYGON_ZKEVM_L2_NETWORK_ID", data: BytesLike): Result;
...
export interface PolygonZkEVM_Adapter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PolygonZkEVM_AdapterInterface;
    ...
    functions: {
        L1_POLYGON_ZKEVM_BRIDGE(overrides?: CallOverrides): Promise<[string]>;
        L1_WETH(overrides?: CallOverrides): Promise<[string]>;
        POLYGON_ZKEVM_L2_NETWORK_ID(overrides?: CallOverrides): Promise<[number]>;
    ...
    estimateGas: {
        L1_POLYGON_ZKEVM_BRIDGE(overrides?: CallOverrides): Promise<BigNumber>;
        L1_WETH(overrides?: CallOverrides): Promise<BigNumber>;
        POLYGON_ZKEVM_L2_NETWORK_ID(overrides?: CallOverrides): Promise<BigNumber>;
        relayMessage(target: string, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
        relayTokens(l1Token: string, l2Token: string, amount: BigNumberish, to: string, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        L1_POLYGON_ZKEVM_BRIDGE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        L1_WETH(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        POLYGON_ZKEVM_L2_NETWORK_ID(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        relayMessage(target: string, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
