...
export interface Blast_RescueAdapterInterface extends utils.Interface {
    functions: {
        ...
        "usdYieldManager()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "relayMessage" | "relayTokens" | "rescueAddress" | "usdYieldManager"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "usdYieldManager", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "usdYieldManager", data: BytesLike): Result;
    events: {
...
export interface Blast_RescueAdapter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Blast_RescueAdapterInterface;
    ...
    functions: {
        ...
        usdYieldManager(overrides?: CallOverrides): Promise<[string]>;
    };
    relayMessage(arg0: string, message: BytesLike, overrides?: PayableOverrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        ...
        usdYieldManager(overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        relayMessage(arg0: string, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        ...
        usdYieldManager(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
