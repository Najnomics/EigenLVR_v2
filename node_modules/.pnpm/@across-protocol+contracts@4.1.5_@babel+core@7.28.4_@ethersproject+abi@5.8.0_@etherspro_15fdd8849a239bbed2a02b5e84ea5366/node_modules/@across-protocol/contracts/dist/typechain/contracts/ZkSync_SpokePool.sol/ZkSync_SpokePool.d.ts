...
export interface ZkSync_SpokePoolInterface extends utils.Interface {
    functions: {
        ...
        "zkUSDCBridge()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "EMPTY_MSG_BYTES" | "EMPTY_RELAYER" | "EMPTY_REPAYMENT_CHAIN_ID" | "INFINITE_FILL_DEADLINE" | "MAX_EXCLUSIVITY_PERIOD_SECONDS" | "MAX_TRANSFER_SIZE" | "OFT_DST_EID" | "OFT_FEE_CAP" | "UPDATE_BYTES32_DEPOSIT_DETAILS_HASH" | "__SpokePool_init" | "cctpTokenMessenger" | "cctpV2" | "chainId" | "claimRelayerRefund" | "crossDomainAdmin" | "deposit" | "depositDeprecated_5947912356" | "depositFor" | "depositNow" | "depositQuoteTimeBuffer" | "depositV3" | "depositV3Now" | "emergencyDeleteRootBundle" | "executeRelayerRefundLeaf" | "executeSlowRelayLeaf" | "fill" | "fillDeadlineBuffer" | "fillRelay" | "fillRelayWithUpdatedDeposit" | "fillStatuses" | "fillV3Relay" | "getCurrentTime" | "getRelayerRefund" | "getUnsafeDepositId" | "getV3RelayHash" | "initialize" | "l2Eth" | "multicall" | "numberOfDeposits" | "oftMessengers" | "pauseDeposits" | "pauseFills" | "pausedDeposits" | "pausedFills" | "proxiableUUID" | "recipientCircleDomainId" | "relayRootBundle" | "relayerRefund" | "requestSlowFill" | "rootBundles" | "setCrossDomainAdmin" | "setOftMessenger" | "setWithdrawalRecipient" | "setZkBridge" | "speedUpDeposit" | "speedUpV3Deposit" | "tryMulticall" | "unsafeDeposit" | "upgradeTo" | "upgradeToAndCall" | "usdcToken" | "withdrawalRecipient" | "wrappedNativeToken" | "zkErc20Bridge" | "zkUSDCBridge"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setZkBridge", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "zkUSDCBridge", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "setZkBridge", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "zkUSDCBridge", data: BytesLike): Result;
    events: {
        ...
        "SetZkBridge(address,address)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "SetZkBridge"): EventFragment;
...
export interface ZkSync_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ZkSync_SpokePoolInterface;
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _zkErc20Bridge: string, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setZkBridge(_zkErc20Bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        zkUSDCBridge(overrides?: CallOverrides): Promise<[string]>;
    };
    EMPTY_MSG_BYTES(overrides?: CallOverrides): Promise<string>;
    EMPTY_RELAYER(overrides?: CallOverrides): Promise<string>;
    EMPTY_REPAYMENT_CHAIN_ID(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        getUnsafeDepositId(msgSender: string, depositor: BytesLike, depositNonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getV3RelayHash(relayData: V3SpokePoolInterface.V3RelayDataStruct, overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _zkErc20Bridge: string, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: CallOverrides): Promise<void>;
        l2Eth(overrides?: CallOverrides): Promise<string>;
        ...
        setZkBridge(_zkErc20Bridge: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "SetZkBridge(address,address)"(erc20Bridge?: string | null, oldErc20Bridge?: string | null): SetZkBridgeEventFilter;
        SetZkBridge(erc20Bridge?: string | null, oldErc20Bridge?: string | null): SetZkBridgeEventFilter;
    ...
    estimateGas: {
        ...
        zkUSDCBridge(overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        zkUSDCBridge(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
