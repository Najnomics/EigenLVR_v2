...
export interface Universal_SpokePoolInterface extends utils.Interface {
    functions: {
        "ADMIN_UPDATE_BUFFER()": FunctionFragment;
        "EMPTY_MSG_BYTES()": FunctionFragment;
        "EMPTY_RELAYER()": FunctionFragment;
        "EMPTY_REPAYMENT_CHAIN_ID()": FunctionFragment;
        "HUB_POOL_STORE_CALLDATA_MAPPING_SLOT_INDEX()": FunctionFragment;
        ...
        "adminExecuteMessage(bytes)": FunctionFragment;
        ...
        "executeMessage(uint256,bytes,uint256)": FunctionFragment;
        ...
        "executedMessages(uint256)": FunctionFragment;
        ...
        "getSlotKey(uint256)": FunctionFragment;
        ...
        "helios()": FunctionFragment;
        "hubPoolStore()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "ADMIN_UPDATE_BUFFER" | "EMPTY_MSG_BYTES" | "EMPTY_RELAYER" | "EMPTY_REPAYMENT_CHAIN_ID" | "HUB_POOL_STORE_CALLDATA_MAPPING_SLOT_INDEX" | "INFINITE_FILL_DEADLINE" | "MAX_EXCLUSIVITY_PERIOD_SECONDS" | "MAX_TRANSFER_SIZE" | "OFT_DST_EID" | "OFT_FEE_CAP" | "UPDATE_BYTES32_DEPOSIT_DETAILS_HASH" | "__SpokePool_init" | "adminExecuteMessage" | "cctpTokenMessenger" | "cctpV2" | "chainId" | "claimRelayerRefund" | "crossDomainAdmin" | "deposit" | "depositDeprecated_5947912356" | "depositFor" | "depositNow" | "depositQuoteTimeBuffer" | "depositV3" | "depositV3Now" | "emergencyDeleteRootBundle" | "executeMessage" | "executeRelayerRefundLeaf" | "executeSlowRelayLeaf" | "executedMessages" | "fill" | "fillDeadlineBuffer" | "fillRelay" | "fillRelayWithUpdatedDeposit" | "fillStatuses" | "fillV3Relay" | "getCurrentTime" | "getRelayerRefund" | "getSlotKey" | "getUnsafeDepositId" | "getV3RelayHash" | "helios" | "hubPoolStore" | "initialize" | "multicall" | "numberOfDeposits" | "oftMessengers" | "owner" | "pauseDeposits" | "pauseFills" | "pausedDeposits" | "pausedFills" | "proxiableUUID" | "recipientCircleDomainId" | "relayRootBundle" | "relayerRefund" | "renounceOwnership" | "requestSlowFill" | "rootBundles" | "setCrossDomainAdmin" | "setOftMessenger" | "setWithdrawalRecipient" | "speedUpDeposit" | "speedUpV3Deposit" | "transferOwnership" | "tryMulticall" | "unsafeDeposit" | "upgradeTo" | "upgradeToAndCall" | "usdcToken" | "withdrawalRecipient" | "wrappedNativeToken"): FunctionFragment;
    encodeFunctionData(functionFragment: "ADMIN_UPDATE_BUFFER", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "HUB_POOL_STORE_CALLDATA_MAPPING_SLOT_INDEX", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "adminExecuteMessage", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "executeMessage", values: [BigNumberish, BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "executedMessages", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "getSlotKey", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "helios", values?: undefined): string;
    encodeFunctionData(functionFragment: "hubPoolStore", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "ADMIN_UPDATE_BUFFER", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "HUB_POOL_STORE_CALLDATA_MAPPING_SLOT_INDEX", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "adminExecuteMessage", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getSlotKey", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "helios", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hubPoolStore", data: BytesLike): Result;
    ...
    events: {
        ...
        "RelayedCallData(uint256,address)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "RelayedCallData"): EventFragment;
...
export interface RelayedCallDataEventObject {
    nonce: BigNumber;
    caller: string;
}
export type RelayedCallDataEvent = TypedEvent<[
    BigNumber,
    string
], RelayedCallDataEventObject>;
export type RelayedCallDataEventFilter = TypedEventFilter<RelayedCallDataEvent>;
...
export type SetOFTMessengerEvent = TypedEvent<[
    string,
    string
], SetOFTMessengerEventObject>;
...
export interface Universal_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Universal_SpokePoolInterface;
    ...
    functions: {
        ADMIN_UPDATE_BUFFER(overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        HUB_POOL_STORE_CALLDATA_MAPPING_SLOT_INDEX(overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        adminExecuteMessage(_message: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        executeMessage(_messageNonce: BigNumberish, _message: BytesLike, _blockNumber: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        executedMessages(arg0: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        getSlotKey(_nonce: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        ...
        helios(overrides?: CallOverrides): Promise<[string]>;
        hubPoolStore(overrides?: CallOverrides): Promise<[string]>;
        ...
        setOftMessenger(token: string, messenger: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        adminExecuteMessage(_message: BytesLike, overrides?: CallOverrides): Promise<void>;
        cctpTokenMessenger(overrides?: CallOverrides): Promise<string>;
        cctpV2(overrides?: CallOverrides): Promise<boolean>;
        chainId(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        executeMessage(_messageNonce: BigNumberish, _message: BytesLike, _blockNumber: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "RelayedCallData(uint256,address)"(nonce?: BigNumberish | null, caller?: null): RelayedCallDataEventFilter;
        RelayedCallData(nonce?: BigNumberish | null, caller?: null): RelayedCallDataEventFilter;
    ...
    estimateGas: {
        ...
        executedMessages(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        fill(orderId: BytesLike, originData: BytesLike, fillerData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        getRelayerRefund(l2TokenAddress: string, refundAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
        getSlotKey(_nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getUnsafeDepositId(msgSender: string, depositor: BytesLike, depositNonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getV3RelayHash(relayData: V3SpokePoolInterface.V3RelayDataStruct, overrides?: CallOverrides): Promise<BigNumber>;
        helios(overrides?: CallOverrides): Promise<BigNumber>;
        hubPoolStore(overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        multicall(data: BytesLike[], overrides?: Overrides & {
    ...
    populateTransaction: {
        ADMIN_UPDATE_BUFFER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        HUB_POOL_STORE_CALLDATA_MAPPING_SLOT_INDEX(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        executedMessages(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        fill(orderId: BytesLike, originData: BytesLike, fillerData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        ...
        getSlotKey(_nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        helios(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        hubPoolStore(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialize(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        multicall(data: BytesLike[], overrides?: Overrides & {
