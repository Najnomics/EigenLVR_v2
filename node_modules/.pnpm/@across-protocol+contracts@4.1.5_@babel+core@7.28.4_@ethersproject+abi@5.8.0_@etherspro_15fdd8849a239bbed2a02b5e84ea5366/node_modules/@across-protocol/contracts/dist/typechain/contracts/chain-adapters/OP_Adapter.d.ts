...
export interface OP_AdapterInterface extends utils.Interface {
    functions: {
        "L1_OP_USDC_BRIDGE()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "L1_OP_USDC_BRIDGE" | "L1_STANDARD_BRIDGE" | "L1_WETH" | "L2_GAS_LIMIT" | "MESSENGER" | "cctpTokenMessenger" | "cctpV2" | "recipientCircleDomainId" | "relayMessage" | "relayTokens" | "usdcToken"): FunctionFragment;
    encodeFunctionData(functionFragment: "L1_OP_USDC_BRIDGE", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "L1_OP_USDC_BRIDGE", data: BytesLike): Result;
...
export interface OP_Adapter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OP_AdapterInterface;
    ...
    functions: {
        L1_OP_USDC_BRIDGE(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        L1_OP_USDC_BRIDGE(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        L1_OP_USDC_BRIDGE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
