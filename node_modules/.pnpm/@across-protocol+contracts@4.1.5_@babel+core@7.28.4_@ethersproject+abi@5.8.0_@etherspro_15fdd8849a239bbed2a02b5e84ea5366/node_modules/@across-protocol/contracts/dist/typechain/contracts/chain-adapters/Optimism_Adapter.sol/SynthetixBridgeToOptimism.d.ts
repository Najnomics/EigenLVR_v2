...
export interface SynthetixBridgeToOptimismInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "depositERC20" | "depositERC20To" | "depositETH" | "depositETHTo" | "depositTo" | "finalizeERC20Withdrawal" | "finalizeETHWithdrawal" | "l2TokenBridge"): FunctionFragment;
...
export type ERC20DepositInitiatedEventFilter = TypedEventFilter<ERC20DepositInitiatedEvent>;
...
export type ERC20WithdrawalFinalizedEventFilter = TypedEventFilter<ERC20WithdrawalFinalizedEvent>;
...
export type ETHDepositInitiatedEventFilter = TypedEventFilter<ETHDepositInitiatedEvent>;
...
export type ETHWithdrawalFinalizedEventFilter = TypedEventFilter<ETHWithdrawalFinalizedEvent>;
export interface SynthetixBridgeToOptimism extends BaseContract {
    ...
    functions: {
        ...
        depositTo(to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        depositTo(to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
