...
export interface MockHubPoolInterface extends utils.Interface {
    functions: {
        ...
        "setPendingRootBundle((bytes32,bytes32,bytes32,uint256,address,uint8,uint32))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "adapter" | "arbitraryMessage" | "balanceOf" | "changeAdapter" | "owner" | "relayTokens" | "rootBundleProposal" | "setPendingRootBundle"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setPendingRootBundle", values: [HubPoolInterface.RootBundleStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "setPendingRootBundle", data: BytesLike): Result;
    events: {
...
export type AdapterChangedEvent = TypedEvent<[
    string,
    string
], AdapterChangedEventObject>;
export type AdapterChangedEventFilter = TypedEventFilter<AdapterChangedEvent>;
export interface MockHubPool extends BaseContract {
    ...
    functions: {
        ...
        setPendingRootBundle(_rootBundleProposal: HubPoolInterface.RootBundleStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    adapter(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        setPendingRootBundle(_rootBundleProposal: HubPoolInterface.RootBundleStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
