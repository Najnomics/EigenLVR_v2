...
export interface Ovm_SpokePoolInterface extends utils.Interface {
    functions: {
...
export interface Ovm_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Ovm_SpokePoolInterface;
