...
export interface FunderInterfaceInterface extends utils.Interface {
    functions: {
...
export interface FunderInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: FunderInterfaceInterface;
