...
export interface Lisk_SpokePoolInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "USDC_BRIDGE", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "USDC_BRIDGE", data: BytesLike): Result;
...
export interface Lisk_SpokePool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Lisk_SpokePoolInterface;
    ...
    functions: {
        ...
        USDC_BRIDGE(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        USDC_BRIDGE(overrides?: CallOverrides): Promise<BigNumber>;
        __OvmSpokePool_init(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, _l2Eth: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        __SpokePool_init(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        USDC_BRIDGE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        __OvmSpokePool_init(_initialDepositId: BigNumberish, _crossDomainAdmin: string, _withdrawalRecipient: string, _l2Eth: string, overrides?: Overrides & {
            from?: string;
