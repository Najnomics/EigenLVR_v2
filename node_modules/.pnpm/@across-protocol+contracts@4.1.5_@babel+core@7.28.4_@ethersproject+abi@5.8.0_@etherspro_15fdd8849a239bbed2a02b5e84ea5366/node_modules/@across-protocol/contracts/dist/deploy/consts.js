...
exports.OFT_EIDs = exports.CIRCLE_DOMAIN_IDs = exports.POLYGON_CHAIN_IDS = exports.L2_ADDRESS_MAP = exports.OP_STACK_ADDRESS_MAP = exports.L1_ADDRESS_MAP = exports.ZK_MAX_GASPRICE = exports.ZK_L2_GAS_LIMIT = exports.ZK_L1_GAS_TO_L2_GAS_PER_PUBDATA_LIMIT = exports.CIRCLE_UNINITIALIZED_DOMAIN_ID = exports.AZERO_GAS_PRICE = exports.ARBITRUM_MAX_SUBMISSION_COST = exports.FILL_DEADLINE_BUFFER = exports.QUOTE_TIME_BUFFER = exports.WGHO = exports.WGRASS = exports.AZERO = exports.WAZERO = exports.WMATIC = exports.WETH = exports.USDCe = exports.USDC = exports.ZERO_ADDRESS = void 0;
...
exports.WMATIC = utils_1.TOKEN_SYMBOLS_MAP.WMATIC.addresses;
exports.WAZERO = utils_1.TOKEN_SYMBOLS_MAP.WAZERO.addresses;
exports.AZERO = utils_1.TOKEN_SYMBOLS_MAP.AZERO;
exports.WGRASS = utils_1.TOKEN_SYMBOLS_MAP.WGRASS.addresses;
exports.WGHO = utils_1.TOKEN_SYMBOLS_MAP.WGHO.addresses;
exports.QUOTE_TIME_BUFFER = 3600;
exports.FILL_DEADLINE_BUFFER = 6 * 3600;
exports.ARBITRUM_MAX_SUBMISSION_COST = "10000000000000000";
exports.AZERO_GAS_PRICE = "240000000000";
exports.CIRCLE_UNINITIALIZED_DOMAIN_ID = 4294967295; // 2^32 - 1
exports.ZK_L1_GAS_TO_L2_GAS_PER_PUBDATA_LIMIT = 800;
exports.ZK_L2_GAS_LIMIT = 2000000;
exports.ZK_MAX_GASPRICE = "10000000000000"; // 10k gwei
exports.L1_ADDRESS_MAP = {
    [utils_1.CHAIN_IDs.MAINNET]: {
...
exports.OP_STACK_ADDRESS_MAP = {
    [utils_1.CHAIN_IDs.MAINNET]: {
        [utils_1.CHAIN_IDs.BASE]: {
            L1CrossDomainMessenger: "0x866E82a600A1414e583f7F13623F1aC5d58b0Afa",
            L1StandardBridge: "0x3154Cf16ccdb4C6d922629664174b904d80F2C35",
        },
        [utils_1.CHAIN_IDs.BOBA]: {
    ...
    [utils_1.CHAIN_IDs.SEPOLIA]: {
        [utils_1.CHAIN_IDs.BASE_SEPOLIA]: {
        ...
        [utils_1.CHAIN_IDs.BLAST_SEPOLIA]: {
        ...
        [utils_1.CHAIN_IDs.LISK_SEPOLIA]: {
        ...
        [utils_1.CHAIN_IDs.MODE_SEPOLIA]: {
        ...
        [utils_1.CHAIN_IDs.OPTIMISM_SEPOLIA]: {
...
exports.L2_ADDRESS_MAP = {
    [utils_1.CHAIN_IDs.ALEPH_ZERO]: {
        l2GatewayRouter: "0xD296d45171B97720D3aBdb68B0232be01F1A9216",
    },
    [utils_1.CHAIN_IDs.ARBITRUM_SEPOLIA]: {
    ...
    [utils_1.CHAIN_IDs.POLYGON_AMOY]: {
        fxChild: "0xE5930336866d0388f0f745A2d9207C7781047C0f",
        cctpTokenMessenger: "0x9f3B8679c73C2Fef8b59B4f3444d4e156fb70AA5",
        cctpMessageTransmitter: "0x7865fAfC2db2093669d92c0F33AeEF291086BEFD",
    },
    [utils_1.CHAIN_IDs.ZK_SYNC]: {
        zkErc20Bridge: "0x11f943b2c77b743AB90f4A0Ae7d5A4e7FCA3E102",
        cctpTokenMessenger: common_1.ZERO_ADDRESS, // CCTP not available on zkSync.
    ...
    [utils_1.CHAIN_IDs.SCROLL_SEPOLIA]: {
...
exports.POLYGON_CHAIN_IDS = {
    ...
    [utils_1.CHAIN_IDs.SEPOLIA]: utils_1.CHAIN_IDs.POLYGON_AMOY,
};
/**
...
const createChainMap = (selector) => new Map(Object.entries(utils_1.PUBLIC_NETWORKS).map(([id, network]) => [Number(id), selector(network)]));
/**
 * Mapping chainId => oft endpoint id
 * @link https://docs.layerzero.network/v2/deployments/deployed-contracts
 */
exports.OFT_EIDs = createChainMap((network) => network.oftEid);
