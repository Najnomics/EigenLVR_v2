...
function getDepositNowDiscriminatorBytes() {
    return (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8).encode(exports.DEPOSIT_NOW_DISCRIMINATOR);
}
...
function getDepositNowInstructionDataCodec() {
    return (0, kit_1.combineCodec)(getDepositNowInstructionDataEncoder(), getDepositNowInstructionDataDecoder());
}
