...
function getUnsafeDepositDiscriminatorBytes() {
    return (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8).encode(exports.UNSAFE_DEPOSIT_DISCRIMINATOR);
}
function getUnsafeDepositInstructionDataEncoder() {
    return (0, kit_1.transformEncoder)((0, kit_1.getStructEncoder)([
        ['discriminator', (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8)],
        ['depositor', (0, kit_1.getAddressEncoder)()],
        ['recipient', (0, kit_1.getAddressEncoder)()],
        ...
        ['fillDeadline', (0, kit_1.getU32Encoder)()],
        ['exclusivityParameter', (0, kit_1.getU32Encoder)()],
        ['message', (0, kit_1.addEncoderSizePrefix)((0, kit_1.getBytesEncoder)(), (0, kit_1.getU32Encoder)())],
...
function getUnsafeDepositInstructionDataDecoder() {
    return (0, kit_1.getStructDecoder)([
        ...
        ['depositor', (0, kit_1.getAddressDecoder)()],
        ['recipient', (0, kit_1.getAddressDecoder)()],
        ...
        ['fillDeadline', (0, kit_1.getU32Decoder)()],
        ['exclusivityParameter', (0, kit_1.getU32Decoder)()],
        ['message', (0, kit_1.addDecoderSizePrefix)((0, kit_1.getBytesDecoder)(), (0, kit_1.getU32Decoder)())],
    ]);
}
function getUnsafeDepositInstructionDataCodec() {
    return (0, kit_1.combineCodec)(getUnsafeDepositInstructionDataEncoder(), getUnsafeDepositInstructionDataDecoder());
}
