...
async function constructSingleRelayerRefundTree(l2Token, destinationChainId, amount) {
    const amountToUse = amount !== undefined ? amount : constants_1.amountToReturn;
...
async function constructSingleChainTree(token, scalingSize = 1, repaymentChain = constants_1.repaymentChainId, decimals = 18) {
    const tokensSendToL2 = (0, utils_1.toBNWeiWithDecimals)(100 * scalingSize, decimals);
    const realizedLpFees = (0, utils_1.toBNWeiWithDecimals)(10 * scalingSize, decimals);
