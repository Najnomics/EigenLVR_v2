...
const { provider, program, connection, assertSE, assert } = SvmSpoke_common_1.common;
describe("svm_spoke.instruction_params", () => {
    ...
    const initializeInstructionParams = async (totalSize) => {
    ...
    const writeInstructionParams = async (data) => {
    ...
    beforeEach(async () => {
        caller = web3_js_1.Keypair.generate();
        ...
        [instructionParams] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("instruction_params"), caller.publicKey.toBuffer()], program.programId);
    });
    it("Initializes instruction params", async () => {
        ...
        if (instructionParamsAccount === null)
