...
describe("Scroll Chain Adapter", function () {
    beforeEach(async function () {
        ...
        scrollAdapter = await (await (0, utils_1.getContractFactory)("Scroll_Adapter", owner)).deploy(l1GatewayRouter.address, l1Messenger.address, l1GasPriceOracle.address, 2_000_000 /* 2M gas limit for arbitrary messages */, 250_000 /* 250k gas limit for tokens */);
    ...
    it("relayMessage calls spoke pool functions", async function () {
        ...
        (0, utils_1.expect)(l1Messenger.sendMessage).to.have.been.calledWith(mockSpoke.address, toBN(0), functionCallData, toBN(2_000_000) // This is baked into the adapter.
        );
    });
    it("Correctly calls appropriate scroll bridge functions when transferring tokens to different chains", async function () {
        ...
        (0, utils_1.expect)(l1GatewayRouter.depositERC20).to.have.been.calledWith(dai.address, mockSpoke.address, tokensSendToL2, toBN(250_000) // This is baked into the adapter.
        );
