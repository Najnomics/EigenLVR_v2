...
export declare function createFakeFromABI(abi: any[], targetAddress?: string): Promise<FakeContract<BaseContract>>;
export declare function createTypedFakeFromABI<T extends BaseContract>(abi: any[], targetAddress?: string): Promise<FakeContract<T>>;
...
export declare function getOftEid(chainId: number): number;
