...
async function main() {
    ...
    const proxy = await hre.zkUpgrades.deployProxy(deployer.zkWallet, contract, [1_000_000, "0x0e2817C49698cc0874204AeDf7c72Be2Bb7fCD5d", consts_1.L1_ADDRESS_MAP[chainId].weth], { initializer: "initialize" });
