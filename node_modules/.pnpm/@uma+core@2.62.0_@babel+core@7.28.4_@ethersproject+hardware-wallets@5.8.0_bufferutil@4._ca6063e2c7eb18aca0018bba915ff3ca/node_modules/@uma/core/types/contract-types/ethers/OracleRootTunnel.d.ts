...
interface OracleRootTunnelInterface extends ethers.utils.Interface {
  functions: {
...
export class OracleRootTunnel extends BaseContract {
  ...
  interface: OracleRootTunnelInterface;
