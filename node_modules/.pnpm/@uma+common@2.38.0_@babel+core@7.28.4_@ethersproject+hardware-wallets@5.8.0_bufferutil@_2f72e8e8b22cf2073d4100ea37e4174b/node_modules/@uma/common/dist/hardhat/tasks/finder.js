...
(0, config_1.task)("setup-finder", "Points Finder to DVM system contracts")
    ...
    const { registry, generichandler, bridge, identifierwhitelist, mockoracle, oraclespoke, addresswhitelist, financialcontractsadmin, store, optimisticoracle, optimisticoraclev2, optimisticoraclev3, sinkoracle, } = taskArguments;
    ...
    if (optimisticoraclev2)
        contractsToSet.push("OptimisticOracleV2");
    if (optimisticoraclev3)
        contractsToSet.push("OptimisticOracleV3");
    if (store)
