...
function getNodeUrl(networkName, useHttps = false, chainId = null) {
    if ((0, PublicNetworks_1.isPublicNetwork)(networkName) && !networkName.includes("fork")) {
        ...
        if (name === "core-testnet")
            return overrideUrl || "https://rpc.test.btcs.network/";
        if (name === "blast-sepolia")
            return overrideUrl || "https://sepolia.blast.io";
        if (name === "core")
            return overrideUrl || "https://rpc.coredao.org/";
        if (name === "story")
            return overrideUrl || "https://mainnet.storyrpc.io/";
        if (name === "base-goerli")
            return overrideUrl || "https://goerli.base.org";
        if (name === "base-sepolia")
            return overrideUrl || "https://sepolia.base.org";
        if (name === "base")
            return overrideUrl || "https://mainnet.base.org";
        if (name === "blast")
            return overrideUrl || "https://rpc.blast.io/";
        if (name === "illiad")
            return overrideUrl || "https://testnet.storyrpc.io/";
        if (name === "odyssey")
            return overrideUrl || "https://odyssey-testnet-explorer.storyscan.xyz";
        return (overrideUrl ||
