...
_workingDir = "./") {
    ...
    const defaultConfig = {
        ...
        networks: {
            ...
            sepolia: { chainId: 11155111, url: (0, ProviderUtils_1.getNodeUrl)("sepolia", true, 11155111), accounts: { mnemonic } },
            "base-goerli": { chainId: 84531, url: (0, ProviderUtils_1.getNodeUrl)("base-goerli", true, 84531), accounts: { mnemonic } },
            "blast-sepolia": {
                chainId: 168587773,
                url: (0, ProviderUtils_1.getNodeUrl)("blast-sepolia", true, 168587773),
                accounts: { mnemonic },
            },
            base: {
                chainId: 8453,
                url: (0, ProviderUtils_1.getNodeUrl)("base", true, 8453),
                accounts: { mnemonic },
                companionNetworks: { mainnet: "mainnet" },
            },
            "base-sepolia": {
                chainId: 84532,
                url: (0, ProviderUtils_1.getNodeUrl)("base-sepolia", true, 84532),
                accounts: { mnemonic },
            },
            ...
            amoy: {
                chainId: 80002,
                url: (0, ProviderUtils_1.getNodeUrl)("polygon-amoy", true, 80002),
                accounts: { mnemonic },
            ...
            "arbitrum-sepolia": {
                chainId: 421614,
                url: (0, ProviderUtils_1.getNodeUrl)("arbitrum-sepolia", true, 421614),
                accounts: { mnemonic },
            },
            illiad: {
                chainId: 1513,
                url: (0, ProviderUtils_1.getNodeUrl)("illiad", true, 1513),
                accounts: { mnemonic },
            },
            odyssey: {
                chainId: 1516,
                url: (0, ProviderUtils_1.getNodeUrl)("odyssey", true, 1516),
                accounts: { mnemonic },
            },
            sx: {
                chainId: 416,
            ...
            "core-testnet": {
                chainId: 1115,
                url: (0, ProviderUtils_1.getNodeUrl)("core-testnet", true, 1115),
                accounts: { mnemonic },
            },
            core: {
                chainId: 1116,
                url: (0, ProviderUtils_1.getNodeUrl)("core", true, 1116),
                accounts: { mnemonic },
                companionNetworks: { mainnet: "mainnet" },
            },
            story: {
                chainId: 1514,
                url: (0, ProviderUtils_1.getNodeUrl)("story", true, 1514),
                accounts: { mnemonic },
                companionNetworks: { mainnet: "mainnet" },
            },
            blast: {
                chainId: 81457,
                url: (0, ProviderUtils_1.getNodeUrl)("blast", true, 81457),
                accounts: { mnemonic },
                companionNetworks: { mainnet: "mainnet" },
            },
        },
