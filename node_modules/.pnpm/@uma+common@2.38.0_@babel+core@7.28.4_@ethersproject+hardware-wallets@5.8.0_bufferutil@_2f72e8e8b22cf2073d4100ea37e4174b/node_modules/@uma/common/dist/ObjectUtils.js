...
exports.isRecordStringUnknown = exports.objectMap = exports.createObjectFromDefaultProps = void 0;
/**
 ...
 */
const isRecordStringUnknown = (input) => {
    return (typeof input === "object" &&
        input !== null &&
        !Array.isArray(input) &&
        Object.keys(input).every((key) => typeof key === "string"));
};
exports.isRecordStringUnknown = isRecordStringUnknown;
module.exports = { createObjectFromDefaultProps: exports.createObjectFromDefaultProps, objectMap: exports.objectMap, isRecordStringUnknown: exports.isRecordStringUnknown };
