...
/**
 * @title EigenLVR_V2 Simple Tests
 * @notice Simple unit tests for EigenLVR_V2 core functionality
 * @dev Basic tests focusing on core hook functionality
 */
contract EigenLVR_V2SimpleTest is BaseEigenLVRTest {
